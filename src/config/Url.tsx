export const API_KEY = "api_key=8cc494f765248cf7c16c25c005a889a8"
export const BASE_URL = "https://api.themoviedb.org/3"
export const SEARCH_URL = BASE_URL + "/search/movie?" +API_KEY

export const GENRE_URL = BASE_URL + "/genre/movie/list?" +API_KEY
export const DETAIL_URL = BASE_URL + "/movie/"
export const DISCOVER_URL = BASE_URL + "/discover/movie?" +API_KEY
